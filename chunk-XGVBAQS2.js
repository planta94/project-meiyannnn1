...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ki,depthTest:!1,depthWrite:!1})}function Zw(i,t,e){let n=new Float32Array(cs),r=new N(0,1,0);return new Jn({name:"SphericalGaussianBlur",defines:{n:cs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:xu(),fragmentShader:`
		...
		`,blending:ki,depthTest:!1,depthWrite:!1})}function mv(){return new Jn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xu(),fragmentShader:`
		...
		`,blending:ki,depthTest:!1,depthWrite:!1})}function gv(){return new Jn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xu(),fragmentShader:`
